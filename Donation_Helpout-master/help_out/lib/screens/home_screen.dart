...
import 'package:help_out/screens/userlist.dart';
import 'package:help_out/screens/profile2.dart';
import 'package:http/http.dart' as http;
import 'dart:convert';
import 'package:help_out/screens/contactus.dart';
...
Drawer _drawer(context) {
  return Drawer(
    child: ListView(padding: EdgeInsets.only(top: 30), children: [
      ...
      //     }),
      ListTile(
          title: Text(translation(context).register, style: TextStyle(fontSize: 20)),
          onTap: () async {
            var url = Uri.parse(
      ...
      ListTile(
          title: Text(translation(context).contact, style: TextStyle(fontSize: 20)),
          onTap: () {
            Navigator.push(
              context,
      ...
      ListTile(
          title: Text(translation(context).aboutUs, style: TextStyle(fontSize: 20)),
          onTap: () {
            Navigator.push(
              context,
      ...
      ListTile(
          title: Text(translation(context).signout, style: TextStyle(fontSize: 20)),
          onTap: () async {
            await _auth.signOut();
            Navigator.push(
              context,
...
AppBar _buildappbar(context) {
  ...
  return AppBar(
    backgroundColor: Color.fromARGB(255, 194, 43, 86),
        title: Text("HelpOut",style: TextStyle(
                    color: Colors.white,
                    fontStyle: FontStyle.normal,
                    fontSize: 28.0)),
        actions: <Widget>[
